    ...
    <div className='space-y-5 py-10 bg-[#fff]'>
        <div className='block lg:flex space-y-5 lg:space-y-0 justify-center items-center mx-auto gap-x-10 px-5'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[20px] font-semibold px-4 text-[#636569]'>Cartes prépayées</p> 
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[20px] font-semibold px-4 text-[#636569]'>Cartes de crédit</p> 
                <div className='text-start text-[14px] px-2 w-full lg:w-[350px] h-[180px]'>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[25px] font-semibold w-full py-3 text-center text-white bg-[#a22a2b] rounded-t-[10px]'>Mastercard Débit Standard </p>
                <p className='text-[20px] font-semibold px-4 text-[#636569]'>Cartes internationales</p> 
                <div className='text-start text-[14px] px-2 w-full lg:w-[350px] h-[180px]'>
        ...
        <div className='shadow-xl rounded-[10px]'>
            ...
            <div className='text-[#000]'>
                ...
                <p className='text-[20px] font-semibold px-4 text-[#636569]'>Cartes Prestiges  </p> 
                <div className='text-start text-[14px] px-2 w-full lg:w-[350px] h-[180px]'>
                    <p>- Prix: 75 USD +TVA</p>
